...
const translations = {
    en: {
        ...
        about_activities_awards: "Activities & Awards",
        about_now: "Now",
        ...
        about_uet_major: "Major: Computer Science (Honors Program)",
    ...
    vi: {
        ...
        about_activities_awards: "Hoạt động & Giải thưởng",
        about_now: "Hiện tại",
        ...
        about_uet_major: "Chuyên ngành: Khoa học máy tính (Chất lượng cao)",
        ...
        award_silver: "<strong>Huy chương Bạc</strong> – Kỳ thi học sinh giỏi lần thứ 12 của các trường THPT chuyên khu vực Đồng bằng sông Hồng và Duyên hải phía Bắc (2019)",
        award_bronze1: "<strong>Huy chương Đồng</strong> – Olympic HSGS ĐHQGHN (2019)",
        award_bronze2: "<strong>Huy chương Đồng</strong> – Kỳ thi học sinh giỏi của các trường THPT chuyên do ĐHQGHN tổ chức (2019)",
        award_violympic: "<strong>Giải Khuyến khích Quốc gia</strong> – Cuộc thi Violympic Toán Tiếng Anh lớp 8, Việt Nam (2017)",
        award_ijso: "<strong>Giải Nhì cấp Thành phố</strong> – Kỳ thi IJSO lớp 9 (2018)",
        award_math9: "<strong>Giải Khuyến khích cấp Thành phố</strong> – Môn Toán lớp 9 (2018)",
